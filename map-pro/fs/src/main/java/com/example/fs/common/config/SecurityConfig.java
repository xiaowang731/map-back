...
import com.example.fs.common.config.filter.JwtAuthenticationFilter;
import com.example.fs.common.exception.handler.AccessDeniedHandlerImpl;
import com.example.fs.common.exception.handler.AuthenticationEntryPointImpl;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests(authorize ->
                ...
                authorize.requestMatchers(
                                ...
                                "/files/**",
                                "/api/v1/message",
                                "/api/v1/message/regen",
                                "/api/v1/system/config",
                                "/api/v1/knowledge/file/download/*",
                                "/api/v1/code-img/*"
                        ).permitAll()
