...
//
// //import com.example.oauthservice.federation.FederatedIdentityAuthenticationSuccessHandler;
...
// // 						authorize
// // 								.requestMatchers("/assets/**", "/webjars/**","/css/**", "/js/**", "/login","/oauth2/**","/oauth2/token").permitAll() //② 忽略鉴权的url
